                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="idPinjaman" id="idPinjaman"
                                value="{{ $tagihan->pinjaman_id }}" onclick="detailPinjaman()" style="cursor: pointer" readonly>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="jatuhTempo" id="jatuhTempo"
...
<script>
    ...
    function detailPinjaman() {
        ...
        const url = '{{ route('pinjaman.detail', ['pinjamanId' => ':pinjamanId']) }}'.replace(':pinjamanId',
            pinjamanId);
