            ...
            <div class="col-md-6">
                <div class="card mb-2">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">2. Masukkan rekening tujuan: <b>1231313131</b> A/N <b>PT
            ...
            <div class="col-md-6">
                        ...
                        <div class="image-card-mycars">
                            ...
                            @if ($tagihan->status === 'ON PROCESS')
                                <button type="button" class="delete-button-mycars"
                                    style="position:absolute;top:0;right:0;background-color:rgba(255,0,0,0.7);color:#fff;border:none;border-radius:50%;cursor:pointer;width:25px;height:25px;display:flex;align-items:center;justify-content:center;"
                ...
                @else
                    <form method="POST" action="{{ route('upload.bukti') }}" enctype="multipart/form-data">
                        @csrf
                        <input type="text" name="tagihanId" id="tagihanId" value="{{ $tagihan->id }}"
                            hidden>
                        <div class="input-group mb-3">
                            <div class="custom-file">
                                <input type="file" name="fileInput" class="custom-file-input"
                                    id="fileInput">
